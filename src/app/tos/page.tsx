...
export default function Page() {
  return (
    <main className="mx-auto max-w-prose space-y-6 p-3 py-6">
      ...
      <p>
        Welcome to Resume Builder. These Terms of Service (&quot;Terms&quot;)
        govern your use of our website and services, including any paid
        subscription plans. By accessing or using Resume Builder (&quot;the
        Service&quot;), you agree to be bound by these Terms. If you do not
        agree to these Terms, do not use the Service.
      </p>
      <h2 className="text-xl font-semibold">1. Overview</h2>
      <p>
        Resume Builder is a SaaS platform that provides resume-building tools
      ...
      <ul className="list-inside list-disc">
        ...
        <li>
          <strong>Refund Policy:</strong> Resume Builder does not offer refunds
          for any payments already processed. However, you can cancel your
      ...
      <p>
        Resume Builder grants you a limited, non-exclusive, non-transferable,
      ...
      <p>
        ...
        Resume Builder are owned by Resume Builder or its licensors. You agree
        not to infringe on these rights.
      </p>
      <h2 className="text-xl font-semibold">10. User Content</h2>
      <p>
        By using the Service, you grant Resume Builder a non-exclusive,
      ...
      <p>
        ...
        services (e.g., Stripe for payments). Resume Builder is not responsible
        for the content or practices of any third-party websites or services.
      </p>
      <h2 className="text-xl font-semibold">13. Disclaimer of Warranties</h2>
      <p>
        The Service is provided on an &quot;as is&quot; and &quot;as
        available&quot; basis. Resume Builder makes no warranties, express or
      ...
      <p>
        To the fullest extent permitted by law, Resume Builder shall not be
      ...
      <p>
        By using Resume Builder, you acknowledge that you have read, understood,
